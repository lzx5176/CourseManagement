    ...
    <div class="row">
        <div class="col-md-9 column">
            <a class="btn btn-primary"
               href="${pageContext.request.contextPath}/course/toAddCourse">新增</a>
            <a class="btn btn-primary"
               href="${pageContext.request.contextPath}/course/allCourse">显示所有课程</a>
                ...
                <c:forEach var="course" items="${list.data}">
                    <tr>
                        ...
                        <td>
                            ...
                            /course/toUpdateCourse?id=${course.getId()}">更改</a> |
                            <a href="${pageContext.request.contextPath}
                            /course/del/${course.getId()}">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
